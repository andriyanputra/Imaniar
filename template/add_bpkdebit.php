...
$(document).ready(function(){
  ...
  $('#add').click(function(){
    ...
    var html_code = "<tr id='row"+count+"'>";
      ...
      html_code += "<td contenteditable='true' class='item_debit'></td>";
  ...
  $('#save').click(function(){
    ...
    $.ajax({
      url:"inc/insert.php",
      method:"POST",
      data:{item_gl:item_gl, item_desc:item_desc, item_debit:item_debit, item_cost:item_cost},
